...
total = len(bands) * channel_count * len(power_levels)
...
with OUTPUT_PATH.open("w", encoding="utf-8", newline="") as f:
    f.write("idx,band_index,band_name,band_letter,channel,frequency,power_value,power_label,lb_us,ub_us,center_us\n")
    for r in rows:
